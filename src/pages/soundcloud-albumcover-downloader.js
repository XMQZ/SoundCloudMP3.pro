...
export default function SoundCloudAlbumCoverDownloaderPage() {
  ...
  const { t } = useTranslation('albumcover');
  ...
  return (
    <main>
      ...
      languageAlternates={[
        {
            "hrefLang": "x-default",
            "href": "https://soundcloudmp3.pro/soundcloud-albumcover-downloader"
        },
        {
            "hrefLang": "en",
            "href": "https://soundcloudmp3.pro/soundcloud-albumcover-downloader"
        ...
        {
            "hrefLang": "es",
            "href": "https://soundcloudmp3.pro/es/soundcloud-albumcover-downloader"
        },
        {
            "hrefLang": "zh-CN",
        ...
        {
            "hrefLang": "hi",
            "href": "https://soundcloudmp3.pro/hi/soundcloud-albumcover-downloader"
        },
        {
            "hrefLang": "ar",
            "href": "https://soundcloudmp3.pro/ar/soundcloud-albumcover-downloader"
        },
        {
            "hrefLang": "fr",
            "href": "https://soundcloudmp3.pro/fr/soundcloud-albumcover-downloader"
        },
        {
            "hrefLang": "pt",
            "href": "https://soundcloudmp3.pro/pt/soundcloud-albumcover-downloader"
        },
        {
            "hrefLang": "bn",
            "href": "https://soundcloudmp3.pro/bn/soundcloud-albumcover-downloader"
        },
        {
            "hrefLang": "ru",
            "href": "https://soundcloudmp3.pro/ru/soundcloud-albumcover-downloader"
        },
        {
            "hrefLang": "de",
            "href": "https://soundcloudmp3.pro/de/soundcloud-albumcover-downloader"
        },
        {
            "hrefLang": "ja",
            "href": "https://soundcloudmp3.pro/ja/soundcloud-albumcover-downloader"
        },
        {
            "hrefLang": "ko",
            "href": "https://soundcloudmp3.pro/ko/soundcloud-albumcover-downloader"
        },
        {
            "hrefLang": "it",
            "href": "https://soundcloudmp3.pro/it/soundcloud-albumcover-downloader"
        },
        {
            "hrefLang": "tr",
            "href": "https://soundcloudmp3.pro/tr/soundcloud-albumcover-downloader"
        },
        {
            "hrefLang": "ur",
            "href": "https://soundcloudmp3.pro/ur/soundcloud-albumcover-downloader"
        },
        {
            "hrefLang": "th",
            "href": "https://soundcloudmp3.pro/th/soundcloud-albumcover-downloader"
        },
        {
            "hrefLang": "sw",
            "href": "https://soundcloudmp3.pro/sw/soundcloud-albumcover-downloader"
        },
        {
            "hrefLang": "fa",
            "href": "https://soundcloudmp3.pro/fa/soundcloud-albumcover-downloader"
        },
        {
            "hrefLang": "vi",
            "href": "https://soundcloudmp3.pro/vi/soundcloud-albumcover-downloader"
        }
      ]}
      />
    ...
    <section className="fjord max-w-6xl mx-auto px-3 py-3 mt-16">
        <h2 className="text-4xl text-center">{t('howToDownloadArtworkTitle')}</h2>
        {t('howToDownloadArtworkSteps', { returnObjects: true }).map((step, index, arr) => (
            <div
                key={index}
            ...
            >
                <div className={`flex ${index % 2 === 0 ? 'md:flex-row' : 'md:flex-row-reverse'} flex-col justify-center items-center px-10`}>
                    <div className="flex justify-center">
                        <img src={`/a${index + 1}.svg`} className="w-[228px] h-[232px]" alt={step.title} />
                    </div>
                    <div className={`font-sans mt-10 ${index % 2 === 0 ? 'md:ml-10' : 'md:mr-10'}`}>
                        ...
                        <p className="mt-4 max-w-xl font-light text-lg md:text-2xl text-gray-700">
                            <Trans ns='albumcover' i18nKey={`howToDownloadArtworkSteps.${index}.description`} components={ [<Link href="/soundcloud-albumcover-downloader" className="text-amber-400" key={0} />] } />
                        </p>
                    </div>
                </div>
            </div>
